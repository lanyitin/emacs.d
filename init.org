   ...
   (let* ((package--builtins nil)
          (packages
           '(auto-compile           ; automatically compile Emacs Lisp libraries
             ...
             org-journal            ; Org-journal is a set of functions to maintain a simple personal diary / journal in Emacs.
             ...
             go-guru                ; go guru wrapper
             flycheck               ; syntax checker
             flycheck-golangci-lint ; flycheck extension for golang
...
** Modes
   ...
   To disable company mode in shell
   #+BEGIN_SRC emacs-lisp
...
** Flyspell
  ...
  #+END_SRC
** Flycheck
   =flycheck= can be used as global mode
...
** Org
   ...
   #+BEGIN_SRC emacs-lisp
   (setq org-agenda-files '("~/Dropbox/notebook/inbox.org")  ; A list of agenda files
         org-agenda-default-appointment-duration 120 ; 2 hours appointments
         org-capture-templates                       ; Template for adding tasks
         '(("t" "Task" entry (file+headline "~/Dropbox/notebook/inbox.org" "Task")
            "** TODO %?" :prepend t)
           ("m" "Todo" entry (file+olp "~/Dropbox/notebook/inbox.org" "Task" "Todo")
            "*** TODO %?" :prepend t)
   ...
   set up org-brain
#+BEGIN_SRC emacs-lisp
(setq org-brain-path (concat org-directory "/wiki"))
  ;; For Evil users
...
#+END_SRC
** Journal
   Note: you have to customize org-journal-dir before you load org-journal as
   otherwise Emacs would not set the mode correctly.
   #+BEGIN_SRC emacs-lisp
   (setq org-journal-dir "~/Dropbox/notebook/journal")
